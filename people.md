...
{% include imagethumbnailblock.html url="/images/people/bahar.jpg" caption="[Dr. Baharul Islam]{:target="_blank"}" width="120px" height="120px"  %}
{% include imagethumbnailblock.html url="/images/people/tarkan.jpg" caption="[Dr. Tarkan Aydın]{:target="_blank"}" width="120px" height="120px"  %}
{% include imagethumbnailblock.html url="/images/people/lavdie.jpg" caption="[Dr. Lavdie Rada]{:target="_blank"}" width="120px" height="120px"  %}
...
{% include imagethumbnailblock.html url="/images/people/masum.jpg" caption="[Masum Shah Junayed]{:target="_blank"}" caption2="M.Sc student" width="120px" height="120px"  %}
